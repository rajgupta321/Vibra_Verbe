import '../thirteen_screen/widgets/frame2_item_widget.dart';
import '../thirteen_screen/widgets/productcomponent4_item_widget.dart';
        ...
        children: [
          ...
          Obx(
            () => CarouselSlider.builder(
              ...
              itemCount:
                  controller.thirteenModelObj.value.frame2ItemList.value.length,
              itemBuilder: (context, index, realIndex) {
                Frame2ItemModel model = controller
                    .thirteenModelObj.value.frame2ItemList.value[index];
          ...
          Obx(
            () => Container(
              ...
              child: AnimatedSmoothIndicator(
                ...
                count: controller
                    .thirteenModelObj.value.frame2ItemList.value.length,
            ...
            child: SizedBox(
              ...
              child: Obx(
                () => ListView.separated(
                  ...
                  itemCount: controller.thirteenModelObj.value
                      .productcomponent4ItemList.value.length,
                  itemBuilder: (context, index) {
                    Productcomponent4ItemModel model = controller
                        .thirteenModelObj
                        .value
                        .productcomponent4ItemList
                        .value[index];
                    return Productcomponent4ItemWidget(
                      model,
                    );
                  },
                ),
